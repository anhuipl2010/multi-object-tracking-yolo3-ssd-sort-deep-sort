...
# ==============================================================================
"""Definition of 300 VGG-based SSD_tf network.

This model was initially introduced in:
SSD_tf: Single Shot MultiBox Detector
...
sys.path.append('../')
from SSD_tf import tf_extended as tfe
...
class SSDNet(object):
	"""Implementation of the SSD_tf VGG-based 300 network.
	...
	def __init__(self, params=None):
		"""Init the SSD_tf net with some parameters. Use the default ones
		if none provided.
		"""
	...
	def detected_bboxes(self, predictions, localisations,
		...
		"""Get the detected bounding boxes from the SSD_tf network output.
		"""
	...
	def losses(self, logits, localisations,
	           ...
	           label_smoothing=0.,
	           scope='ssd_losses'):
		"""Define the SSD_tf network losses.
		"""
...
def ssd_size_bounds_to_values(size_bounds,
	...
	implementation of SSD_tf in Caffe.
...
def ssd_anchor_one_layer(img_shape,
                         ...
                         offset=0.5,
                         dtype=np.float32):
	"""Computer SSD_tf default anchor boxes for one feature layer.
	...
	# Weird SSD_tf-Caffe computation using steps values...
	y, x = np.mgrid[0:feat_shape[0], 0:feat_shape[1]]
	...
	# Tries to follow the original implementation of SSD_tf for the order.
...
# =========================================================================== #
# Functional definition of VGG-based SSD_tf 300.
# =========================================================================== #
...
def ssd_losses_old(logits, localisations,
                   ...
                   device='/cpu:0',
                   scope=None):
	"""Loss functions for training the SSD_tf 300 VGG network.

	This function defines the different loss components of the SSD_tf, and
