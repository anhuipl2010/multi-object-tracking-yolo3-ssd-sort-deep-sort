...
# ==============================================================================
"""Shared function between different SSD_tf implementations.
"""
import numpy as np
import tensorflow as tf
import SSD_tf.tf_extended as tfe


# =========================================================================== #
# TensorFlow implementation of boxes SSD_tf encoding / decoding.
# =========================================================================== #
def tf_ssd_bboxes_encode_layer(labels,
                               ...
                               dtype=tf.float32):
    """Encode groundtruth labels and bounding boxes using SSD_tf anchors from
    one layer.
    ...
    def body(i, feat_labels, feat_scores,
        ...
        Follow the original SSD_tf paper for that purpose:
    ...
    # Use SSD_tf ordering: x / y / w / h instead of ours.
...
def tf_ssd_bboxes_encode(labels,
    ...
    """Encode groundtruth labels and bounding boxes using SSD_tf net anchors.
...
def tf_ssd_bboxes_decode(feat_localizations,
    ...
    """Compute the relative bounding boxes from the SSD_tf net features and
...
def tf_ssd_bboxes_select_layer(predictions_layer, localizations_layer,
    ...
    Args:
      predictions_layer: A SSD_tf prediction layer;
      localizations_layer: A SSD_tf localization layer;
...
def tf_ssd_bboxes_select(predictions_net, localizations_net,
    ...
    Args:
      predictions_net: List of SSD_tf prediction layers;
