...
# ==============================================================================
"""Generic evaluation script that evaluates a SSD_tf model
on a given dataset."""
import math
import time
...
tf.app.flags.DEFINE_boolean(
    'wait_for_checkpoints', False, 'Wait for new model_data in the eval loop.')
...
def main(_):
    ...
    with tf.Graph().as_default():
        ...
        # =================================================================== #
        # Dataset + SSD_tf model + Pre-processing
        # =================================================================== #
        dataset = dataset_factory.get_dataset(
            FLAGS.dataset_name, FLAGS.dataset_split_name, FLAGS.dataset_dir)

        # Get the SSD_tf network and its anchors.
        ...
        with tf.device('/cpu:0'):
            with tf.name_scope(FLAGS.dataset_name + '_data_provider'):
                provider = slim.dataset_data_provider.DatasetDataProvider(
                    ...
                    shuffle=False)
            # Get for SSD_tf network: image, labels, bboxes.
        ...
        # =================================================================== #
        # SSD_tf Network + Ouputs decoding.
        # =================================================================== #
        dict_metrics = {}
        ...
        with tf.device('/device:CPU:0'):
            # Detected objects from SSD_tf output.
